...
if (isset($_POST['btn_upload'])) {
    ...
    if (mysqli_query($con, $query)) {
        ...
        $query1 = "insert into tbl_product_photo (p_id,photo,event_id)   values ('$id','$filepath','$event')";
        ...
        <div class="container body">
            <div class="main_container">
                ...
                <div class="right_col" role="main">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Add L.E.D Products</h2>
                            <div class="clearfix"></div>
                        </div>
                        <div class="x_content">
                            <form method="post" action="Led_product.php" enctype="multipart/form-data" class="form-horizontal form-label-left">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <textarea required="" maxlength="50" minlength="2"  name="txtdesc" class="form-control col-md-7 col-xs-12"></textarea>
                                    </div>
                                </div>
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input name="txtprice" maxlength="8" required="" class="form-control col-md-7 col-xs-12"  placeholder="e.g. 20000"  type="number">
                                    </div>
                                </div>
